import { FaReact, FaMobileAlt,FaNode,FaVuejs,FaLaravel,FaDatabase } from 'react-icons/fa';
...
export const data = [
  ...
  
  {
    title: "Vue",
    Icon: FaVuejs,
    text: "Responsive design is an approach to making web pages usable on different devices.",
    href: 'https://redux.js.org/',
  },
  {
    title: "Node Js",
    Icon: FaNode,
    text: "Node.js is a web development framework created by Vercel enabling React-based app.",
