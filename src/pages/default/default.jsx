...
export default function DefaultPage() {
  ...
  return (
    <div className="default-wrapper">
      <ul data-aos="" data-aos-delay='400' className="navigate">
        ...
        <li><span onClick={() => linkTo('/service')} data-text="Skills"><FaCode /></span></li>
        <li><span onClick={() => linkTo('/works')} data-text="Projects"><MdWork /></span></li>
