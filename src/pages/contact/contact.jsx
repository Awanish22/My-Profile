...
import {
  FaUserAlt,FaUserTie, FaInfoCircle, FaLink, FaFacebook, FaInstagram,
  ...
  return (
    <div className="container contact-wrapper">
      ...
      <div className="box-container">
        <div className="box">
          <h3 data-aos='fade-right' data-aos-delay='0'><span><FaUserTie /></span> AWANISH</h3>
          <p data-aos='fade-right' data-aos-delay='200'>This website is made with React JS</p>
          <div data-aos='fade-right' data-aos-delay='300' className="share">
            <a href="https:" target="_blank" rel="noopener noreferrer" ><FaFacebook /></a>
            <a href="https:" target="_blank" rel="noopener noreferrer"><FaInstagram /></a>
        ...
        <div className="box">
          ...
          <a data-aos='fade-up' data-aos-delay='200' href="tel:+998883521214" className="links"><span><FaUserAlt /></span> +91 7275198770</a>
          <a data-aos='fade-up' data-aos-delay='400' href="mailto:mustafoev0806@gmail.com" className="links"><span><FaEnvelope /></span> awanish131@gmail.com</a>
          <a data-aos='fade-up' data-aos-delay='600' href="https://www.google.com/maps/place/Samarkand,+Uzbekistan/@39.6402225,66.6382411,10z/data=!3m1!4b1!4m5!3m4!1s0x3f4d191960077df7:0x487636d9d13f2f57!8m2!3d39.627012!4d66.9749731" target="_blank" rel="noopener noreferrer" className="links"><span><FaMapMarkerAlt /></span> UP, INDIA</a>
        </div>
        {/* <div className="box">
      ...
      {/* <div data-aos='zoom-out' data-aos-delay='1000' className="credit"> Created by Mr. <span> | A | </span>{new Date().getFullYear()} ©️ All Rights Reserved! </div> */}
    </div>
  )
}
